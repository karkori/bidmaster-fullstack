        ...
        return findAuctionById(id)
                .flatMap(existingAuction -> {
                    ...
                    if (existingAuction.getStatus() != AuctionStatus.DRAFT) {
                        return Mono.error(new IllegalStateException("Solo se pueden actualizar subastas en estado borrador"));
                    }
        ...
        return findAuctionById(id)
                .flatMap(auction -> {
                    if (auction.getStatus() != AuctionStatus.DRAFT) {
                        return Mono.error(new IllegalStateException("Solo se pueden eliminar subastas en estado borrador"));
                    }
